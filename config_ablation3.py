# config_ablation3.py
# Configuration for Ablation 3: Full System Local-Only
# - FSM enabled, multi-model consensus (3x nano), sensor fusion enabled, all local
# - Tests full system with multi-model consensus vs Ablation 3b (1x nano)
...
# ABLATION 3: Enable sensor fusion
...
# ABLATION 3: Multi-model consensus with nano models
model_size = "nano"
model_number = 3
...
# ABLATION 3: Enable baselines for sensor fusion
...
# ABLATION 3: Force everything local
INFERENCE_ROUTING = {
    "S0": "local",
    "S1": "local",
    "S2": "local",
...
# ABLATION 3: Platform-specific tier (nano on Pi, small on Jetson)
...
RESULTS_STORAGE_DIR = "storage/data_results/ablation3"
RESULTS_VIDEO_STORAGE_DIR = "storage/video_results/ablation3"
