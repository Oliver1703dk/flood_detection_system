...
# - FSM enabled, multi-model consensus, sensor fusion enabled, all local inference
...
# MQTT inference settings (not used for this ablation)
...
# ABLATION 3: Force all inference to be local
INFERENCE_ROUTING = {
    "S0": "local",
    "S1": "local",
    "S2": "local",
